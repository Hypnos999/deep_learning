...
if __name__ == '__main__':
    ...
    #
    # model = tf.keras.Model(inputs=[input_layer], outputs=[output], name="BERT")
    model = tf.keras.models.load_model(
        'results/bert/bert.h5',
    ...
    # history = model.fit(x_train, y_train, epochs=epochs, batch_size=32*2*2, validation_split=0.2, callbacks=[early_stop])
    # model.save('results/bert/bert.h5')
    # model.save_weights('results/bert/bert.weights.h5')
    model.load_weights('results/bert/bert.weights.h5')
    ...
    # plt.savefig('results/bert/accuracy.png')
    # plt.show()
    #
    # # Loss
    ...
    # plt.xlabel('epoch')
    # plt.legend(['train', 'validation'], loc='upper left')
    # plt.savefig('results/bert/loss.png')
    # plt.show()
    ...
    plt.tight_layout()
    plt.savefig('results/bert/confusion_matrix.png')
    plt.show()
